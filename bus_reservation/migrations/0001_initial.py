# Generated by Django 5.1.3 on 2024-11-17 10:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('bus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='bus_reservation.bus')),
            ],
        ),
        migrations.CreateModel(
            name='User',
